...
data class SubtitleClip(
    ...
    val isBendingEnabled: Boolean = false,
    val isReflectionEnabled: Boolean = false,
    val glowColor: Int = 0xFFFF0000.toInt(),
    val glowSize: Float = 0f,
    val bendingAmount: Float = 0f,
    val reflectionOffset: Float = 0f,
    val reflectionOpacity: Float = 0.5f,
    val reflectionColor: Int = 0xFFFFFFFF.toInt(),
