...
import com.typography.animations.entrance.*

/**
 * Entrance animation dispatcher.
 * Delegates to individual Kotlin files in the entrance/ package.
 */
object EntranceAnimations {
    ...
    fun evaluate(type: AnimationType, t: Float): AnimatedTextState {
        return when (type) {
            ...
            AnimationType.ELASTIC_STRETCH -> evaluateElasticStretch(t)
            AnimationType.SPIRAL_DROP -> evaluateSpiralDrop(t)
