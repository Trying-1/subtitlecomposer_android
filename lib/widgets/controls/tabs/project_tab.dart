  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (AppConfig.showTimelineColors) ...[
        ...
        const SizedBox(height: 32),
        const Text('PREVIEW SETTINGS', style: TextStyle(fontSize: 8, color: Colors.deepPurpleAccent, fontWeight: FontWeight.w900, letterSpacing: 1.0)),
        const SizedBox(height: 16),
        Row(
          children: [
            const Expanded(child: Text('Show Pan Mode Toggle', style: TextStyle(color: Colors.white70, fontSize: 11))),
            Switch(
              value: context.watch<EditorProvider>().showPanControls,
              onChanged: (v) => context.read<EditorProvider>().toggleShowPanControls(),
