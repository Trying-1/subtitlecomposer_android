           ...
           Column(
            ...
            children: [
              ...
              CommonControls.buildDialScrubber(
                context,
                'Brightness',
                widget.selectedOverlay!.brightness,
                0.0,
                3.0,
                (v) => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, brightness: v),
                onReset: () => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, brightness: 1.0),
              ),
              const SizedBox(height: 12),
              CommonControls.buildDialScrubber(
                context,
                'Saturation',
                widget.selectedOverlay!.saturation,
                0.0,
                3.0,
                (v) => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, saturation: v),
                onReset: () => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, saturation: 1.0),
              ),
              const SizedBox(height: 12),
              CommonControls.buildDialScrubber(
                context,
                'Contrast',
                widget.selectedOverlay!.contrast,
                0.0,
                3.0,
                (v) => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, contrast: v),
                onReset: () => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, contrast: 1.0),
              ),
              const SizedBox(height: 12),
              CommonControls.buildDialScrubber(
                context,
                'Blur',
                widget.selectedOverlay!.blur,
                0.0,
                25.0,
                (v) => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, blur: v),
                onReset: () => context.read<EditorProvider>().updateClip(widget.selectedOverlay!.id, blur: 0.0),
              ),
            ],
          )
